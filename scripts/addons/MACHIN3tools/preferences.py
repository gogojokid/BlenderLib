...
class MACHIN3toolsPreferences(bpy.types.AddonPreferences):
    ...
    cursor_show_to_grid: BoolProperty(name="Show Cursor and Selected to Grid", default=True)
    ...
    tools_show_quick_favorites: BoolProperty(name="Show Quick Favorites", default=True)
    tools_show_tool_bar: BoolProperty(name="Show Tool Bar", default=True)
    ...
    screencast_show_idname: BoolProperty(name="Display Operator's idnames", description="Display Operator's bl_idname properties", default=True)

    custom_startup: BoolProperty(name="Startup Scene", default=False)
    custom_theme: BoolProperty(name="Theme", default=False)
    custom_matcaps: BoolProperty(name="Matcaps", default=False)
    ...
    activate_assetbrowser_tools: BoolProperty(name="Assetbrowser Tools", default=True, update=update_activate_assetbrowser_tools)
    ...
    use_group_sub_menu: BoolProperty(name="Use Group Sub-Menu", default=True)
