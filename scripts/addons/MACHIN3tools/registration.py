...
keys = {'SMART_VERT': [{'label': 'Merge Last', 'keymap': 'Mesh', 'idname': 'machin3.smart_vert', 'type': 'ONE', 'value': 'PRESS','ctrl':True, 'properties': [('mode', 'MERGE'), ('mergetype', 'LAST'), ('slideoverride', False)]},
        ...
        'SMART_EDGE': [{'label': 'Smart Edge', 'keymap': 'Mesh', 'idname': 'machin3.smart_edge', 'type': 'TWO', 'value': 'PRESS','ctrl':True, 'properties': [('sharp', False), ('offset', False)]},
                       ...
                       {'label': 'Offset Edges', 'keymap': 'Mesh', 'idname': 'machin3.smart_edge', 'type': 'TWO','alt':True, 'ctrl': False, 'value': 'PRESS', 'properties': [('sharp', False), ('offset', True)]}],
        'SMART_FACE': [{'keymap': 'Mesh', 'idname': 'machin3.smart_face', 'type': 'FOUR', 'ctrl': True,  'value': 'PRESS'}],
        'CLEAN_UP': [{'keymap': 'Mesh', 'idname': 'machin3.clean_up', 'type': 'THREE', 'ctrl': True, 'value': 'PRESS'}],
